...
urlpatterns = [
    ...
    path('atlas/', atlas_histologico_view, name='atlas_histologico_alias'),
    path('widgets/', alumed_widgets_view, name='alumed_widgets'),
    path('widgets/preguntas/', alumed_widgets_view, name='alumed_widgets_view'),
    ...
    path('conecta/biblioteca/', conecta_biblioteca_view),
    path('biblioteca/lector/<int:book_id>/', conecta_biblioteca_lector_view, name='conecta_biblioteca_lector'),
    path('conecta/biblioteca/lector/<int:book_id>/', conecta_biblioteca_lector_view),
    ...
    path('papiro/', papiro_profe_joy_view, name='papiro_profe_joy'),
