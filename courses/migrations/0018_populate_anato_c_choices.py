# Generated by Django 5.1.15 on 2026-07-21 06:15

from django.db import migrations

def add_anato_choices(apps, schema_editor):
    SimulacroQuestion = apps.get_model('courses', 'SimulacroQuestion')
    questions = [
        {
            "subject": "Anatomía",
    ...
    for q in questions:
        if not SimulacroQuestion.objects.filter(question_text=q['question_text']).exists():
            SimulacroQuestion.objects.create(
                subject=q['subject'],
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0017_alter_simulacroquestion_subject'),
    ]

    operations = [
        migrations.RunPython(add_anato_choices),
    ]
