        ...
        with sync_playwright() as p:
            ...
            def click_breadcrumb_parent(parent_name):
                ...
                js_code = '''() => {
                    ...
                    // 1. Busca elemento visível cujo texto normalizado seja exatamente igual ao nome da pasta pai
                        ...
                        .forEach(el => {
                            ...
                            if (is_visible && normalizeString(text).includes(norm_parent)) {
                                candidates.push({
                                    ...
                                    text: text.replace(/\\n/g, '[NL]'),
                                    length: text.length,
                                    is_nav: el.closest('nav, [class*="breadcrumb"], [class*="navigation"]') !== null
                                });
                            }
                        });
