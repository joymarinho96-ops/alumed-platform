...
# Find start of generarPanelJoy and end before abrirFragmento
start_pos = code.find("function determinarTipoError")
if start_pos == -1:
    start_pos = code.find("function generarPanelJoy")

end_pos = code.find("function abrirFragmento")

nuevo_bloque_joy = """function determinarTipoError(q, seleccionada) {
...
clean_code = code[:start_pos] + nuevo_bloque_joy + code[end_pos:]

with open("app.js", "w", encoding="utf-8") as f:
    f.write(clean_code)

print("Reemplazo quirúrgico del bloque Profe Joy finalizado.")
